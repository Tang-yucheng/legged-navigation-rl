...
#define NODE_MAIN_LOGGER_NAME "legged_interaction_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libgo2_interaction.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<legged::Class_Legged_Interaction>";
