...
void MapIncremental()
{
    ...
    // std::cout << "feats_down_world size: " << feats_down_world->size() << std::endl;
...
int main(int argc, char ** argv)
{
    ...
    auto pub_odom_aft_mapped = nh->create_publisher<nav_msgs::msg::Odometry>("aft_mapped_to_init", 1000);
